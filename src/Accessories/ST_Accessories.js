const { knownCapabilities } = require("../Constants");
...
module.exports = class ST_Accessories {
    ...
    try {
      ...
      accessory
        ...
        .setCharacteristic(
          ...
          deviceData.capabilities["Switch"] !== undefined
        )
        .setCharacteristic(
        ...
        .setCharacteristic(
          ...
          `${that.myUtils.toTitleCase(deviceData.modelName)}`
        )
  ...
  initializeDeviceCharacteristics(accessory) {
    ...
    for (let index in accessory.context.deviceData.capabilities) {
      if (
        knownCapabilities.indexOf(index) === -1 &&
        this.platform.unknownCapabilities.indexOf(index) === -1
      ) {
    ...
    let isFan =
      capabilities["Fan"] !== undefined ||
      capabilities["Fan Light"] !== undefined ||
      capabilities["FanLight"] !== undefined ||
      capabilities["Fan Speed"] ||
      commands.lowSpeed !== undefined;
    let isWindowShade =
      capabilities["WindowShade"] !== undefined ||
      capabilities["Window Shade"] !== undefined;
    let isLight =
      capabilities["LightBulb"] !== undefined ||
      capabilities["Light Bulb"] !== undefined ||
      capabilities["Bulb"] !== undefined ||
      capabilities["Fan Light"] !== undefined ||
      capabilities["FanLight"] !== undefined ||
      devData.name.includes("light");
    let isSpeaker = capabilities["Speaker"] !== undefined;
    let isSonos = devData.manufacturerName === "Sonos";

    if (devData && capabilities) {
      if (
        (capabilities["Switch Level"] !== undefined ||
          capabilities["SwitchLevel"] !== undefined) &&
        !isSpeaker &&
        !isFan &&
        !isMode &&
        !isRoutine
        ...
        if (
          isWindowShade ||
          commands.levelOpenClose ||
          commands.presetPosition
        ) {
          // This is a Window Shade
          deviceGroups.push("window_shade");
          thisCharacteristic = accessory
      ...
      if (
        capabilities["Garage Door Control"] !== undefined ||
        capabilities["GarageDoorControl"] !== undefined
      ) {
      ...
      if (
        ...
        (capabilities["Fan Light"] !== undefined ||
          capabilities["FanLight"] !== undefined ||
          Object.keys(deviceGroups).length < 1)
      ) {
      ...
      // Smoke Detectors
      if (
        (capabilities["Smoke Detector"] !== undefined ||
          capabilities["SmokeDetector"] !== undefined) &&
        attributes.smoke
      ) {
        ...
        if (capabilities["Tamper Alert"] || capabilities["TamperAlert"]) {
          thisCharacteristic = accessory
            ...
            .on("get", callback => {
              callback(
                null,
                attributes.tamperAlert === "detected"
      ...
      if (
        (capabilities["Carbon Monoxide Detector"] !== undefined ||
          capabilities["CarbonMonoxideDetector"] !== undefined) &&
        ...
        if (
          capabilities["Tamper Alert"] !== undefined ||
          capabilities["TamperAlert"] !== undefined
        ) {
          thisCharacteristic = accessory
            .getOrAddService(Service.CarbonMonoxideSensor)
            .getCharacteristic(Characteristic.StatusTampered)
      ...
      if (
        (capabilities["Carbon Dioxide Measurement"] !== undefined ||
          capabilities["CarbonDioxideMeasurement"] !== undefined) &&
        attributes.carbonDioxideMeasurement
      ) {
      ...
      if (
        capabilities["Motion Sensor"] !== undefined ||
        capabilities["MotionSensor"] !== undefined
      ) {
      ...
      if (
        capabilities["Water Sensor"] !== undefined ||
        capabilities["WaterSensor"] !== undefined
      ) {
      ...
      if (
        capabilities["Presence Sensor"] !== undefined ||
        capabilities["PresenceSensor"] !== undefined
      ) {
      ...
      if (
        capabilities["Relative Humidity Measurement"] !== undefined ||
        capabilities["RelativeHumidityMeasurement"] !== undefined
      ) {
      ...
      if (
        capabilities["Temperature Measurement"] !== undefined ||
        capabilities["TemperatureMeasurement"] !== undefined
      ) {
      ...
      if (
        capabilities["Illuminance Measurement"] !== undefined ||
        capabilities["IlluminanceMeasurement"] !== undefined
      ) {
        // console.log(devData);
      ...
      if (
        (capabilities["Contact Sensor"] !== undefined &&
          capabilities["Garage Door Control"] === undefined) ||
        (capabilities["ContactSensor"] !== undefined &&
          capabilities["GarageDoorControl"] === undefined)
      ) {
      ...
      if (
        capabilities["Energy Meter"] !== undefined &&
        !capabilities.Switch &&
        Object.keys(deviceGroups).length < 1
      ) {
      ...
      if (
        capabilities["Power Meter"] !== undefined &&
        !capabilities.Switch &&
        !deviceGroups.length
      ) {
      ...
      if (
        capabilities["Acceleration Sensor"] !== undefined ||
        capabilities["AccelerationSensor"] !== undefined
      ) {
        // deviceGroups.push('accel_sensor')
      }
      if (
        capabilities["Three Axis"] !== undefined ||
        capabilities["ThreeAxis"] !== undefined
      ) {
        // deviceGroups.push('3_axis_sensor')
      }
      if (
        capabilities["Air Quality Sensor"] !== undefined ||
        capabilities["AirQualitySensor"] !== undefined
      ) {
      ...
      this.client
        ...
        .then(data => {
          ...
          for (let i = 0; i < accessory.services.length; i++) {
            for (
              let j = 0;
              j < accessory.services[i].characteristics.length;
              j++
            ) {
              accessory.services[i].characteristics[j].getValue();
            }
